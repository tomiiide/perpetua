...
- Venue behavioral contracts (BookEngine, conformance bar, perf budgets) live in CORE_SPEC.md; the conformance suite is `@perpetua/core/testing` (`runConformance`), run against fixture-fed venues, never live APIs.
